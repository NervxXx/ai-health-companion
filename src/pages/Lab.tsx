    ...
    <MobileFrame>
      <div className="flex flex-col min-h-full">
        <div className="flex-1 px-5 pt-4 pb-2">
          <h1 className="text-xl font-bold text-foreground mb-1">Visual check</h1>
          ...
          <motion.button
            ...
            className="w-full aspect-square max-h-[260px] border-2 border-dashed border-border rounded-3xl flex flex-col items-center justify-center gap-3 mb-6 transition-colors hover:border-primary/40"
          >
